            ...
            <Card className='cursor-pointer' header={<CardHeader titleText='Sedan Garage' subtitleText='2nd Cross Street,K.K Nagar,Madurai' additionalText='4.4 / 5' />} >
                <div className='px-4 py-4'>
                    ...
                    <div className='flex gap-1'>
                        ...
                        <Button className='w-full mt-3' design='Default'>Delete</Button>
                        <Button className='w-full mt-3' design='Emphasized'>Edit</Button>
                    </div>
...
export default ManageGarageCard